...
facet_labels <- list(
  log_nei = c(
    "log_nei_pm25_10000m" = "PM2.5 (10,000m radius)",
    "log_nei_pm25_15000m" = "PM2.5 (15,000m radius)",
    "log_nei_pm25_25000m" = "PM2.5 (25,000m radius)"),
  urc_year = c(
    "urc2006" = "2006 Urban-Rural Classification",
    "urc2013" = "2013 Urban-Rural Classification"))
...
ggplot(pm_long_urc, aes(x = urbanicity, y = emissions)) +
  ...
  facet_wrap(~ urc_year + 
               log_nei, labeller = labeller(urc_year = as_labeller(facet_labels$urc_year),
...
In conclusion, we successfully predicted the annual concentration of air pollution with an accuracy of 61.9%. When factoring in climate regions, our model achieved even higher accuracy, reaching approximately 62.6%. This could show that regional climate factors are influential in understanding air pollution patterns. Analyzing feature importance reveals that the variable “state” holds the highest significance, highlighting its critical role in determining pollution levels. This suggests that geographic factors are critical in determining our air quality…
